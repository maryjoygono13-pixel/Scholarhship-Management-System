...
const inboxTabs = document.querySelectorAll(".notif-tab");
...
const inboxViewReplyBtn = document.getElementById("inboxViewReplyBtn");
...
const inboxLogName = document.getElementById("inboxLogName");
const inboxLogEmail = document.getElementById("inboxLogEmail");
const inboxLogStudentId = document.getElementById("inboxLogStudentId");
const inboxLogSubject = document.getElementById("inboxLogSubject");
const inboxLogMessage = document.getElementById("inboxLogMessage");

let inboxMessages = [];
let inboxOpenId = null;
let inboxSearchTimer;

function inboxEscape(str) {
